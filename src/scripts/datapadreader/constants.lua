Datapadreader = {
    ...
    ui_root = "datapadreader-ui",
    ui_root_frame = "datapadreader-ui-frame",
    ui_root_leftflow = "datapadreader-ui-left-flow",
    ...
    item_datapad_empty = "datapad-empty",
    item_datapad_wdata = "datapad-with-data"
  }